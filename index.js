...
const addFlavor = (array, flavor) => {array.unshift(flavor); return array}
...
const removeLastFlavor = (array) => {array.pop(); return array}
...
const getFlavorByIndex = (array, i) => {return array[i]}
...
function removeFlavorByName(array, flavor){
  let indexOfFlavor = array.indexOf(flavor);
...
function getRandomFlavors(array1, array2, array3, array4){
   let randomFlavors = [];
   let newArray = array1.concat(array2, array3, array4);
   let theLenght = newArray.length;
   for(let i = 0; i < 31; i++) {
      let random = Math.floor(Math.random() * theLenght);
      randomFlavors.push(newArray[random]);
